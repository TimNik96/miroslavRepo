...
var Launch = function Launch(launch) {
  ...
  var divLaunch = document.createElement('div');
  divLaunch.classList.add('launch');
  divLaunch.classList.add('col-3');
  if (index % 3 !== 0) divLaunch.classList.add('offset-1');
  var imgPatch = document.createElement('img');
  imgPatch.src = launch.links.mission_patch;
  var pRocketName = document.createElement('p');
  pRocketName.textContent = launch.rocket.rocket_name;
  var pLaunchYear = document.createElement('p');
...
/* harmony import */ var _Launch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Launch */ "./src/components/Launch.js");


var divIspis = document.querySelector(".ispis");

var LaunchId = function LaunchId() {
  ...
  divForm.addEventListener("submit", function (event) {
    ...
    var singleLaunchInput = document.querySelector('.launchIdForm input[type="text"]');
    Object(_services__WEBPACK_IMPORTED_MODULE_0__["getSingleLaunch"])(singleLaunchInput.value).then(function (response) {
      divIspis.innerHTML = "";
      divIspis.appendChild(Object(_Launch__WEBPACK_IMPORTED_MODULE_1__["default"])(response.data));
...
/* harmony default export */ __webpack_exports__["default"] = (LaunchId);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_Launch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/Launch */ "./src/components/Launch.js");
/* harmony import */ var _components_LaunchId__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/LaunchId */ "./src/components/LaunchId.js");
...
var divIspis = document.querySelector(".ispis");
var allLaunchesBtn = document.querySelector(".all_launches_btn");
var launchIdBtn = document.querySelector(".launch_id_btn");
var launchesPerYearBtn = document.querySelector(".launches_per_year_btn");
var formContainer = document.querySelector(".form_container");
var loader = Object(_components_Loader__WEBPACK_IMPORTED_MODULE_2__["default"])();
allLaunchesBtn.addEventListener("click", function (e) {
  divIspis.innerHTML = "";
  divIspis.appendChild(loader);
  Object(_services__WEBPACK_IMPORTED_MODULE_3__["getAllLaunches"])().then(function (response) {
    var allLaunches = [];
    allLaunches = response.data.filter(function (launch) {
      return launch.links.mission_patch !== null;
    });
    divIspis.removeChild(loader);
    allLaunches.forEach(function (l, index) {
      divIspis.appendChild(Object(_components_Launch__WEBPACK_IMPORTED_MODULE_0__["default"])(l, index));
    });
  });
});
launchIdBtn.addEventListener("click", function (e) {
  formContainer.innerHTML = "";
  formContainer.appendChild(Object(_components_LaunchId__WEBPACK_IMPORTED_MODULE_1__["default"])());
  formContainer.classList.add("height_100");
  formContainer.classList.add("animation");
});
launchesPerYearBtn.addEventListener("click", function (e) {
  formContainer.innerHTML = "";
  formContainer.classList.add("height_100");
  ...
  Object(_services__WEBPACK_IMPORTED_MODULE_3__["getAllLaunches"])().then(function (response) {
    ...
    launchYear.forEach(function (year) {
    ...
    divForm.addEventListener("submit", function (event) {
      ...
      Object(_services__WEBPACK_IMPORTED_MODULE_3__["getAllLaunches"])().then(function (response) {
        ...
        divIspis.innerHTML = "";
        launchesPerYear.forEach(function (l, index) {
          divIspis.appendChild(Object(_components_Launch__WEBPACK_IMPORTED_MODULE_0__["default"])(l, index));
        });
      });
    });
...
/*!*************************!*\
  !*** ./src/services.js ***!
  \*************************/
/*! exports provided: getAllLaunches, getSingleLaunch */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAllLaunches", function() { return getAllLaunches; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSingleLaunch", function() { return getSingleLaunch; });
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");

var getAllLaunches = function getAllLaunches() {
  return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("https://api.spacexdata.com/v3/launches");
};
var getSingleLaunch = function getSingleLaunch(flight_number) {
  return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get("https://api.spacexdata.com/v3/launches/".concat(flight_number));
};
